...
function ReviewerLogin({ onLoginSuccess }) {
  ...
  return (
    <div style={{ maxWidth: 350, margin: '50px auto', padding: '30px', backgroundColor: '#1e1e1e', borderRadius: '10px', boxShadow: '0 8px 24px rgba(0, 0, 0, 0.5)', textAlign: 'center', border: '1px solid #333' }}>
      ...
      <h2 style={{ marginTop: 0, marginBottom: '25px', color: '#fff', fontWeight: '500' }}>Reviewer Login</h2>
      ...
      <form onSubmit={handleSubmit} style={{ textAlign: 'left' }}>
        <div style={{ marginBottom: 15 }}>
          ...
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="reviewer@example.com" style={{ width: '100%', padding: '12px', borderRadius: '6px', border: '1px solid #444', backgroundColor: '#2a2a2a', color: '#fff', boxSizing: 'border-box', outline: 'none' }} />
        </div>
