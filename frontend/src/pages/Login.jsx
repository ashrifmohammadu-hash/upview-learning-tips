...
function Login({ onLoginSuccess }) {
  ...
  return (
    <div style={{ 
      ...
      borderRadius: '10px',
      boxShadow: '0 8px 24px rgba(0, 0, 0, 0.5)', // Added shadow
      textAlign: 'center',
      border: '1px solid #333'
    }}>
      {/* Added the logo you uploaded */}
      <img src="/logo.png" alt="Logo" style={{ width: '80px', marginBottom: '20px', borderRadius: '8px' }} />
      <h2 style={{ marginTop: 0, marginBottom: '25px', color: '#fff', fontWeight: '500' }}>Welcome Back</h2>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
            <input
              ...
              style={{ 
                width: '100%', 
                padding: '12px', 
                paddingRight: '60px', // Make room for the show/hide button
                borderRadius: '6px', 
                border: '1px solid #444',
                backgroundColor: '#2a2a2a',
                color: '#fff',
        ...
        <div style={{ textAlign: 'center' }}>
          <button 
            ...
            style={{ 
              width: '100%', 
              padding: '14px', 
              backgroundColor: '#ff5722', // Matching the orange from your logo
              color: 'white', 
              fontWeight: 'bold',
              borderRadius: '6px',
              border: 'none',
